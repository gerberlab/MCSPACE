...
def evaluate_case(datapath, results, ds, npart, nreads, base_sample):    
...
def main(rootdir, outdir):
    ...
    for ds in dsets:
        ...
        for npart in npart_cases:
            ...
            results = evaluate_case(datapath, results, ds, npart, "default", base_sample)

        for nreads in nreads_cases:
            print(f"\tanalyzing number reads={nreads}")
            results = evaluate_case(datapath, results, ds, "default", nreads,  base_sample)
